...
<head>
    ...
    <link href="../templates/assets1/global/plugins/carousel-owl-carousel/owl-carousel/owl.carousel-rtl.css"
          rel="stylesheet">
...
<%--            <h1>${txtS}</h1>--%>
            ...
            <h1><c:out value="${txtS}" escapeXml="true"/></h1>
            ...
            <div class="sidebar col-md-3 col-sm-5">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    ...
                    <ul class="dropdown-menu" style="display:block;">
                        ...
                        <li class="list-group-item dropdown clearfix  ">
                            <a href="/home/category?cid=0" class="collapsed"><i class="fa fa-angle-right"></i>
                                <h3>CATEGORY</h3></a>

                            <c:forEach items="${AllCate}" var="c">


                        <li class="list-group-item clearfix"><a href="/home/category?cid=${c.id}"><i
                                class="fa fa-angle-right"></i> ${c.name}</a></li>
                ...
                <div class="sidebar-products clearfix">
                    ...
                    <c:forEach items="${list3}" var="i">
                        <div class="item">
                            <a href="/home/product?pid=${i.id}"><img src="${i.image}"
                                                                     alt="Some Shoes in Animal with Cut Out"></a>
                            <h3><a href="/home/product?pid=${i.id}">${i.name}</a></h3>
                            <div class="price"> <fmt:formatNumber value="${i.price}" type="currency" maxFractionDigits="0" currencySymbol="VNĐ"/> VNĐ</div>
                        </div>
                    </c:forEach>
                </div>
